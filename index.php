...
$routes = [
    ...
    'signup/getdistricts' => 'SignUpController@getdistricts',
    'signup/getcities' => 'SignUpController@getcities',
    ...
    'driver/getvdata' => 'DriverController@getvehidata',
    ...
    'admin/edititem' => 'AdminController@edititem',
    'admin/delete_item' => 'AdminController@delete_item',
