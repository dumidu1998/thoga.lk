            ...
            <div>
                ...
                <div id="myModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div >
                            <form action="postForum" method="post" class="newforum">
                                <input type="text" name="topic" id="" placeholder="Title for Your Question">
                                <textarea name="description" id="" class="description" cols="30" rows="50" placeholder="Description"oninput="auto_grow(this)" ></textarea> 
                                <hr>
                                <input type="submit" name="post_forum" class="fsubmit-btn" value="Post">
                            </form>
                        </div>
                    </div>
                </div>
