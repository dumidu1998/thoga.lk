...
// echo $length;
foreach($data_city1 as $key => $value){
              ...
              <div class="modal-content">
                  ...
                  <div>
                      ...
                      <div class="item_data">
                        ...
                        <input type="number" id="qnty" name="quantity" min="<?php echo $min_val ?>" max= "<?php echo $avail_we ?>"step= "1" class="form-control" value="<?php echo $min_val ?>" />kg  
