...
<div class="topnav" id="myTopnav">
  ...
  <div class = "nav-right">
    ...
    <a href="driveruserprofile"><img src="bell.jpg" alt="" class = "bell_pic" width=25px>
    <a href="driveruserprofile" class="active"><img src="profile.png" alt="" class = "index_pic" width=25px>
